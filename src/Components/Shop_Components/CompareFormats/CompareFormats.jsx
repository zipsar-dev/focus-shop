...
export default function CompareFormats() {
  return (
    <div className="bg-white border border-black rounded-[12px] p-8 md:p-10 max-w-[76%] mx-auto my-12">
        ...
        {formats.map((format, index) => (
          ...
          >
            <div>
              ...
              {format.subtitle && (
                <p className="text-xs text-gray-500 ml-8 mb-2">{format.subtitle}</p>
              )}
              <hr className="my-2" />
